...
import '../../features/address/choose_address_manually_screen.dart';
import '../../features/address/welcome_screen.dart';
import '../../features/auth/view/screens/auth_screen.dart';
import '../../features/auth/view/screens/create_account_screen.dart';
import '../../features/auth/view/screens/forgot_password_screen.dart';
import '../../features/auth/view/screens/login_with_email_screen.dart';
import '../../features/cart/view/screens/cart_screen.dart';
import '../../features/categories/food_category/view/screens/food_category_screen.dart';
import '../../features/categories/food_category/view/screens/product_details_res_screen.dart';
import '../../features/categories/food_category/view/screens/restaurant_date_details_screen.dart';
import '../../features/categories/food_category/view/screens/restaurant_screen.dart';
import '../../features/categories/grocery_category/view/screens/grocery_store_details.dart';
import '../../features/categories/grocery_category/view/screens/grocery_stores_screen.dart';
import '../../features/categories/health_category/view/screens/health_category_screen.dart';
import '../../features/categories/health_category/view/screens/health_product_details.dart';
import '../../features/categories/health_category/view/screens/health_products_screen.dart';
import '../../features/categories/health_category/view/screens/health_stores_screen.dart';
import '../../features/categories/mart_category/views/screens/mart_category_screen.dart';
import '../../features/categories/mart_category/views/screens/mart_product_details.dart';
import '../../features/categories/mart_category/views/screens/mart_products_screen.dart';
import '../../features/categories/mart_category/views/screens/mart_stores_screen.dart';
import '../../features/checkout/view/screens/checkout_screen.dart';
import '../../features/main/view/screens/account_screen.dart';
import '../../features/main/view/screens/home_screen.dart';
import '../../features/main/view/screens/layout_view.dart';
import '../../features/main/view/screens/search_screen.dart';
import '../../features/offer/view/screens/offer_screen.dart';
import '../../features/orders/view/screens/orders_screen.dart';
import '../../features/splash/presentation/views/splash.dart';
import '../../viewonboarding/core/constant/imagesassets.dart';
import '../../viewonboarding/core/constant/routes.dart';
import '../../viewonboarding/view/screens/onbording.dart';
...
// static const String SplashView = "/SplashView";
AppRoutes.splashView: (c) => const SplashView(),
...
AppRoutes.welcomeScreen: (c) => const WelcomeScreen(),
  ...
  AppRoutes.onBoarding: (c) => const OnBoarding(),
