...
import '../../../../shared/widgets/custom_Store_item.dart';


class HealthStoresScreen extends StatelessWidget {
  const HealthStoresScreen({super.key});
                        ...
                        ListView.separated(
                          ...
                          itemBuilder: (context, index) => InkWell(
                            onTap: () {
                              Navigator.pushNamed(
                                context,
                                AppRoutes.healthCategoryScreen,
                              );
                            },
                            child: CustomStoreItem(
                              name: 'el azaby ',
                              category: 'Cosmetic',
                              image: ImageAssetsManager.saidlityLogo,
                            ),
                          ),
